...
class Main extends Component {
	...
	render() {
		return (
			<div>
				<Navigation
					oAuthData={this.props.oAuthData}
				...
				<Switch>
					<Route
						exact
						path="/"
						render={() => <QuestionList signedIn={this.props.signedIn} userId={this.props.userId} />}
					/>
						...
						render={() => {
							{
								if (!this.props.oAuthData) {
									return (
										<Login uiConfig={this.props.uiConfig} firebaseAuth={this.props.firebaseAuth} />
									);
								} else {
									return (
										<Query
